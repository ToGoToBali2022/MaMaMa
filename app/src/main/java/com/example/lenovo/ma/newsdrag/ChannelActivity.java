package com.example.lenovo.ma.newsdrag;
...
import com.example.lenovo.ma.IApplication;
import com.example.lenovo.ma.R;
import com.example.lenovo.ma.newsdrag.adapter.DragAdapter;
import com.example.lenovo.ma.newsdrag.adapter.OtherAdapter;
import com.example.lenovo.ma.newsdrag.bean.ChannelItem;
import com.example.lenovo.ma.newsdrag.bean.ChannelManage;
import com.example.lenovo.ma.newsdrag.view.DragGrid;
import com.example.lenovo.ma.newsdrag.view.OtherGridView;
import com.example.lenovo.ma.utils.NetUtil;
...
public class ChannelActivity extends Activity implements OnItemClickListener {
    ...
    private void initData() {
       ...
       userGridView.setOnItemClickListener(new OnItemClickListener() {
        ...
        ab = new AlertDialog.Builder(ChannelActivity.this);
